               ...
               echo "echo "Script Created By overses.net"" > /usr/local/bin/deleteduser
               ...
               echo "echo "overses.net- Username : $username sudah expired Pada Tanggal: $tgl $bulantahun dan telah di delete pada tanggal: $hariini "" >> /usr/local/bin/deleteduser
